...
.PHONY: all mlsblk install-mlsblk install-linuxify bsdcoreutils clean help
...
help:
	...
	@echo "  make bsdcoreutils     Build BSD coreutils (requires cmake + submodule)"
...
bsdcoreutils:
	@if [[ ! -d bsdcoreutils/upstream ]]; then \
